...
namespace CourseWork.Web.Migrations
{
    ...
    [Migration("20211128133603_AddedUserBoardSubscriptions")]
    partial class AddedUserBoardSubscriptions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseWork.Core.Database.Entities.Profile.UserBoardSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_board_subscriptions");

                    b.HasIndex("BoardId")
                        .HasDatabaseName("ix_user_board_subscriptions_board_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_board_subscriptions_user_id");

                    b.ToTable("user_board_subscriptions");
                });
            ...
            modelBuilder.Entity("CourseWork.Core.Database.Entities.Profile.UserBoardSubscription", b =>
                {
                    b.HasOne("CourseWork.Core.Database.Entities.Boards.PotatoBoard", "Board")
                        ...
                        .HasConstraintName("fk_user_board_subscriptions_boards_board_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("CourseWork.Core.Database.Entities.Identity.AppUser", "User")
                        ...
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_user_board_subscriptions_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
